  ...
  <body>
   <div class="body"></div>
    ...
    <div class="navbar-header" style="background:  rgba(0,0,0,0);">
      ...
      <a style="color: #000;" class="navbar-brand active " href="index.php" >Side <span style="color: #5379fa;"> Plus </span></a>
    </div>
         ...
         <div style="margin-top: 20px; margin-bottom: 20px; background: rgba(9,2,19,0.3); ">
            ...
            <div id="author" class="col-md-12">
              ...
              <span id="sua-xoa"   style="display:  <?php    
                ...
                if( $rowAuthor['author'] == $rowPost['author']  ) {echo 'block';} else {echo 'none';}  ;  ?> "  > <a onclick=" xoa() " href="xoapost.php?id_post=<?php echo $rowPost['id_post'] ?>"> xóa</a> |  <a href="suapost.php?id_post=<?php echo $rowPost['id_post']; ?> "> sửa</a>           
                </span>
                </p>
              </div>
            <div></div>  

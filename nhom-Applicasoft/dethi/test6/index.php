...
<body>
	...
	<?php $response=mysqli_query($con,"select * from questions where made=6");?>
	...
	<?php 
		...
		echo "<img style='display: block; margin-left: auto; margin-right: auto; border: 1px solid #ddd;' src='../image/de6/".$result->image."'>";
	?>
	<hr >
	<br />
	<div class='align'>

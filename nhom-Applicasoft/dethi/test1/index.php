...
<body>
	...
	<hr/>
	<?php $response=mysqli_query($con,"select * from questions where made=1");?>
	...
	<h3 id="question_<?php echo $result->id;?>">Câu <?php echo $result->id.". ".$result->question_name;?>
	</h3><hr/>
	<?php 
		if($result->image =='') echo '';else
		echo "<img class='img-fluid' style='display: block; margin-left: auto; margin-right: auto' src='../image/de1/".$result->image."'>";
	?>
	<hr >
	<br />

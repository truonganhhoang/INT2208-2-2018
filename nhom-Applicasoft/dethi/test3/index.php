...
<body>
	...
	<?php $response=mysqli_query($con,"select * from questions where made=3");?>
	...
	<?php 
		...
		echo "<img style='display: block; margin-left: auto; margin-right: auto; border: 1px solid #ddd;' src='../image/de3/".$result->image."'>";
	?>
	<hr >
	<br />
	<div class='align'>

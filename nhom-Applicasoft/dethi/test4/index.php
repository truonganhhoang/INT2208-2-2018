...
<body>
	...
	<?php $response=mysqli_query($con,"select * from questions where made=4");?>
	...
	<?php 
		...
		echo "<img style='display: block; margin-left: auto; margin-right: auto; border: 1px solid #ddd;' src='../image/de4/".$result->image."'>";
	?>
	<hr >
	<br />
	<div class='align'>

            ...
            <div class="row">
                ...
                <div class="col-xs-10 col-sm-6">
                    <div class="panel panel-body panel-primary" id="c1">
                        ...
                        <br>
                        <a routerLink="/minmax10" routerLinkActive="active">Tìm số lớn nhất bé nhất trong phạm vi 10</a>
                    </div>
                </div>
                <div class="col-xs-10 col-sm-6">
                    <div class="panel panel-body panel-primary" id="c2">
                        ...
                        <br>
                        <a routerLink="/sub20" routerLinkActive="active">Phép trừ 20</a>
                        <br>
                        <a routerLink="/sum20" routerLinkActive="active">Phép cộng 20</a>
                        <br>
            ...
            <div class="row">
                <div class="col-xs-10 col-sm-6">
                    <div class="panel panel-body panel-primary" id="c3">
                        ...
                        <br>
                        <a routerLink="/sub100" routerLinkActive="active">Phép trừ phạm vi 100</a>
                        <br>
                        <a routerLink="/sum100" routerLinkActive="active">Phép cộng phạm vi 100</a>
                        <br>

  ...
  <div class="row">
    ...
    <div class="col-lg-9">
      ...
      <div id="major" class="tabcontent">
        <img src="chord library/D major.jpg" class="chord-picture1">
        <img src="chord library/D major 2.jpg" class="chord-picture1">
        <img src="chord library/D major 3.jpg" class="chord-picture1">
        <img src="chord library/D major 4.jpg" class="chord-picture1">
        <img src="chord library/D major 5.jpg" class="chord-picture1">
        <img src="chord library/D major 6.jpg" class="chord-picture1">
      </div>
      <div id="minor" class="tabcontent chord-picture">
        <img src="chord library/D minor.jpg" class="chord-picture1">
        <img src="chord library/D minor 1.jpg"  class="chord-picture1">
        <img src="chord library/D minor 2.jpg"  class="chord-picture1">
      </div>
      <div id="5" class="tabcontent chord-picture">
        <img src="chord library/D5.jpg" class="chord-picture1">
        <img src="chord library/D5 1.jpg"  class="chord-picture1">
        <img src="chord library/D5 2.jpg"  class="chord-picture1">
        <img src="chord library/D5 3.jpg"  class="chord-picture1"> 
        <img src="chord library/D5 4.jpg"  class="chord-picture1"> 
        <img src="chord library/D5 5.jpg"  class="chord-picture1">
      </div>
      <div id="7" class="tabcontent chord-picture">
        <img src="chord library/D7.jpg" class="chord-picture1">
        <img src="chord library/D7 1.jpg"  class="chord-picture1">
        <img src="chord library/D7 2.jpg"  class="chord-picture1">
        <img src="chord library/D7 3.jpg"  class="chord-picture1"> 
      </div>
      <div id="maj7" class="tabcontent chord-picture">
        <img src="chord library/Dmaj7.jpg" class="chord-picture1">
        <img src="chord library/Dmaj7 1.jpg"  class="chord-picture1">
        <img src="chord library/Dmaj7 2.jpg"  class="chord-picture1">
        <img src="chord library/Dmaj7 3.jpg"  class="chord-picture1"> 
        <img src="chord library/Dmaj7 4.jpg"  class="chord-picture1"> 
        <img src="chord library/Dmaj7 5.jpg"  class="chord-picture1">
      </div>
      <div id="m7" class="tabcontent chord-picture">
        <img src="chord library/Dm7.jpg" class="chord-picture1">
        <img src="chord library/Dm7 1.jpg"  class="chord-picture1">
        <img src="chord library/Dm7 2.jpg"  class="chord-picture1">
      </div>
      <div id="sus4" class="tabcontent chord-picture">
        <img src="chord library/Dsus4.jpg" class="chord-picture1">
        <img src="chord library/Dsus4 1.jpg"  class="chord-picture1">
        <img src="chord library/Dsus4 2.jpg"  class="chord-picture1">
      </div>
      <div id="add9" class="tabcontent chord-picture">
        <img src="chord library/Dadd9.jpg" class="chord-picture1">
      </div>
      <div id="sus2" class="tabcontent chord-picture">
        <img src="chord library/Dsus2.jpg" class="chord-picture1">
        <img src="chord library/Dsus2 1.jpg"  class="chord-picture1">
      </div>
      ...
      <div id="7#9" class="tabcontent chord-picture">
        <img src="chord library/D7thang9.jpg" class="chord-picture1">
        <img src="chord library/D7thang9 1.jpg"  class="chord-picture1">
      </div>
      <div id="9" class="tabcontent chord-picture">
        <img src="chord library/D9.jpg" class="chord-picture1">
        <img src="chord library/D9 1.jpg"  class="chord-picture1">
        <img src="chord library/D9 2.jpg"  class="chord-picture1">
      </div>
      <!-- /.row -->

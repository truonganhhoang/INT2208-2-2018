...
<head>
  ...
  <title>Music theory lesson1</title>
...
<div class="container">
  ...
  <div class="row">
   ...
   <div class="col-lg-3">
     ...
     <div class="list-group menu1">
      <a href="#" class="list-group-item musictheory-lesson1-title"><u>Lesson 1: Basic notes</u></a>
  ...
  <div class="col-lg-9">
    ...
    <div class="row row1">
     <h2 class="musictheory-lesson1-title" style="padding-left: 10px;">Lesson 1: Basic notes</h2>
     <h5 class="title-row"></h5>
     <div class="col-lg-4 col-md-6 mb-4 box-border">
      <div class="card h-100 title-border">
        <div class="card-body">
          <h4 class="card-title">
            <a href="#" class="title-color">The Staff</a>
          </h4>
          <h5 class="card-text">The staff is the basis of written music. It is what the notes are presented on. It consists of 5 lines with four spaces between them each represent a different musical pitch—or, in the case of a percussion staff, different percussion instruments. A simple, unadorned staff is shown below.</h5>
          <img src="img/cleanstaff-ee98d0e1.png" class="musictheory-lesson1-picture">
          <h5>The musical staff is analogous to a mathematical graph of pitch with respect to time. Pitches of notes are given by their vertical position on the staff and notes are played from left to right. Unlike a graph, however, the number of semitones represented by a vertical step from a line to an adjacent space depends on the key, and the exact timing of the beginning of each note is not directly proportional to its horizontal position; rather, exact timing is encoded by the musical symbol chosen for each note in addition to the tempo.</h5>
    ...
    <div class="card-footer card-footer-border">
      <a href ="musictheory-lesson1.php" class="btn btn-primary btn-lesson-next">NEXT: Sharp and flat</a>
    </div>

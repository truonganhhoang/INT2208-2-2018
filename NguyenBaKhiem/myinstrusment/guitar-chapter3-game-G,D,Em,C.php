...
<div class="container">
  ...
  <div class="col-lg-9">
    ...
    <div class="row row-card "   id="row1">
      <div class="flip3d"   >
        <div id="front1"  class="front"  onclick="fronttoback('front1','back1','continuous1')" ><img src="chord library/G major.jpg" class="imgflip"></div>
        <div id="back1" class="back"  onclick="backtofront('front1','back1')"><h1 class="fliptext">G chord</h1></div>
      </div> 
    ...
    <div class="row row-card " style="display: none;"   id="row2">
      <div class="flip3d" style="margin-top: 100px;" >
        <div id="front2"  class="front"  onclick="fronttoback('front2','back2','continuous2')" ><img src="chord library/D major.jpg" class="imgflip"></div>
        <div id="back2" class="back"  onclick="backtofront('front2','back2')"><h1 class="fliptext">D chord</h1></div>
      </div> 
      <div style=" width: 100%;  height: 40px;margin-top: 0px; "><h5 style="width: 140px; color: gray;margin: auto;" >Click to open</h5></div>
    ...
    <div class="row row-card " style="display: none; "   id="row3" >
      <div style="margin:auto;width: 90%;height: 80%">
        <div class="img3d"  style="margin-top: 100px;width: 50%; float: left;" >
          <div  class="front" style="float: left" id="img3d-1"><img src="chord library/D major.jpg" class="imgflip"></div>
        </div> 
        <div  style="width: 50% ;float: right;margin-top: 120px" class="answer-card-total"  >
          <div class="answer-card" id="right1" onclick="right('right1','img3d-1','continuous3')" ><h3 style="width: 140px; margin: auto;" >D chord</h3></div>
          <div class="answer-card" id="wrong1-1" onclick="wrong('wrong1-1')"><h3 style="width: 140px; margin: auto;" >C chord</h3></div>
          <div class="answer-card" id="wrong1-2" onclick="wrong('wrong1-2')"><h3 style="width: 140px; margin: auto;" >Em chord</h3></div>
        </div>
      </div>
    ...
    <div class="row row-card " style="display: none; "   id="row4" >
      <div style="margin:auto;width: 90%;height: 80%">
        <div class="img3d"  style="margin-top: 100px;width: 50%; float: left;" >
          <div  class="front" style="float: left" id="img3d-2"><img src="chord library/G major.jpg" class="imgflip"></div>
        </div> 
        <div  style="width: 50% ;float: right;margin-top: 120px" class="answer-card-total"  >
          <div class="answer-card" id="wrong2-1" onclick="wrong('wrong2-1')" ><h3 style="width: 140px; margin: auto;" >D chord</h3></div>
          <div class="answer-card" id="right2"  onclick="right('right2','img3d-2','continuous4')"><h3 style="width: 140px; margin: auto;" >G chord</h3></div>
    ...
    <div class="row row-card " style="display: none; "   id="row5" >
      <div style="margin:auto;width: 90%;height: 80%">
        <div class="img3d"  style="margin-top: 100px;width: 50%; float: left;" >
          <div  class="front" style="float: left" id="img3d-3"><img src="chord library/G major.jpg" class="imgflip"></div>
        </div> 
        <div  style="width: 50% ;float: right;margin-top: 120px" class="answer-card-total"  >
          <div class="answer-card" id="wrong3-1" onclick="wrong('wrong3-1')" ><h3 style="width: 140px; margin: auto;" >D chord</h3></div>
          <div class="answer-card" id="wrong3-2" onclick="wrong('wrong3-2') "><h3 style="width: 140px; margin: auto;" >Em chord</h3></div>
          <div class="answer-card" id="right3" onclick="right('right3','img3d-3','continuous5')"><h3 style="width: 140px; margin: auto;" >G chord</h3></div>
        </div>
      </div>
    ...
    <div class="row row-card " style="display: none;"   id="row6">
      <div class="flip3d" style="margin-top: 100px;" >
        <div id="front6"  class="front"  onclick="fronttoback('front6','back6','continuous6')" ><img src="chord library/Eminor.jpg" class="imgflip"></div>
        <div id="back6" class="back"  onclick="backtofront('front6','back6')"><h1 class="fliptext">Em chord</h1></div>
      </div> 
      <div style=" width: 100%;  height: 40px;margin-top: 0px; "><h5 style="width: 140px; color: gray;margin: auto;" >Click to open</h5></div>
    ...
    <div class="row row-card " style="display: none; "   id="row7" >
      <div style="margin:auto;width: 90%;height: 80%">
        <div class="img3d"  style="margin-top: 100px;width: 50%; float: left;" >
          <div  class="front" style="float: left" id="img3d-7"><img src="chord library/G major.jpg" class="imgflip"></div>
        </div> 
        <div  style="width: 50% ;float: right;margin-top: 120px" class="answer-card-total"  >
          <div class="answer-card" id="wrong7-1" onclick="wrong('wrong7-1')" ><h3 style="width: 140px; margin: auto;" >D chord</h3></div>
          <div class="answer-card" id="right7" onclick="right('right7','img3d-7','continuous7')"><h3 style="width: 140px; margin: auto;" >G chord</h3></div>
          <div class="answer-card" id="wrong7-2" onclick="wrong('wrong7-2')"><h3 style="width: 140px; margin: auto;" >C chord</h3></div>
        </div>
      </div>
    ...
    <div class="row row-card " style="display: none; "   id="row8" >
      ...
      <div style="display: none;" class="continue-card" id="continuous8"><h4 style="width: 140px; margin: auto;text-align: center" onclick="showdisplay('row8','last')">continue</h4></div>
    </div>
    <div class="row row-card " style="display: none;"   id="last">
      ...
      <div  class="continue-card" id="continuous9"><a href="guitar-chapter3-game.php"><h4 style="width: 180px; margin: auto;text-align: center; margin-top: 220px;" >back to game</h4></a></div>
    </div>

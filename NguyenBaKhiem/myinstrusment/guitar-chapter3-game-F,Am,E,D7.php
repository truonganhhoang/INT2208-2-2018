...
<div class="container">
  ...
  <div class="col-lg-9">
    ...
    <div class="row row-card "   id="row1">
      <div class="flip3d"   >
        <div id="front1"  class="front"  onclick="fronttoback('front1','back1','continuous1')" ><img src="chord library/F major.jpg" class="imgflip"></div>
        <div id="back1" class="back"  onclick="backtofront('front1','back1')"><h1 class="fliptext">F chord</h1></div>
      </div> 
    ...
    <div class="row row-card " style="display: none;"   id="row2">
      <div class="flip3d" style="margin-top: 100px;" >
        <div id="front2"  class="front"  onclick="fronttoback('front2','back2','continuous2')" ><img src="chord library/A minor.jpg" class="imgflip"></div>
        <div id="back2" class="back"  onclick="backtofront('front2','back2')"><h1 class="fliptext">Am chord</h1></div>
      </div> 
      <div style=" width: 100%;  height: 40px;margin-top: 0px; "><h5 style="width: 140px; color: gray;margin: auto;" >Click to open</h5></div>
    ...
    <div class="row row-card " style="display: none; "   id="row3" >
      <div style="margin:auto;width: 90%;height: 80%">
        <div class="img3d"  style="margin-top: 100px;width: 50%; float: left;" >
          <div  class="front" style="float: left" id="img3d-1"><img src="chord library/A minor.jpg" class="imgflip"></div>
        </div> 
    ...
    <div class="row row-card " style="display: none; "   id="row4" >
      <div style="margin:auto;width: 90%;height: 80%">
        <div class="img3d"  style="margin-top: 100px;width: 50%; float: left;" >
          <div  class="front" style="float: left" id="img3d-2"><img src="chord library/F major.jpg" class="imgflip"></div>
        </div> 
        <div  style="width: 50% ;float: right;margin-top: 120px" class="answer-card-total"  >
          <div class="answer-card" id="wrong2-1" onclick="wrong('wrong2-1')" ><h3 style="width: 140px; margin: auto;" >Am chord</h3></div>
    ...
    <div class="row row-card " style="display: none; "   id="row5" >
      <div style="margin:auto;width: 90%;height: 80%">
        <div class="img3d"  style="margin-top: 100px;width: 50%; float: left;" >
          <div  class="front" style="float: left" id="img3d-3"><img src="chord library/A minor.jpg" class="imgflip"></div>
        </div> 
        <div  style="width: 50% ;float: right;margin-top: 120px" class="answer-card-total"  >
          ...
          <div class="answer-card" id="right3" onclick="right('right3','img3d-3','continuous5')"><h3 style="width: 140px; margin: auto;" >Am chord</h3></div>
        </div>
      </div>
    ...
    <div class="row row-card " style="display: none;"   id="row6">
      <div class="flip3d" style="margin-top: 100px;" >
        <div id="front6"  class="front"  onclick="fronttoback('front6','back6','continuous6')" ><img src="chord library/E major.jpg" class="imgflip"></div>
        <div id="back6" class="back"  onclick="backtofront('front6','back6')"><h1 class="fliptext">E chord</h1></div>
      </div> 
      <div style=" width: 100%;  height: 40px;margin-top: 0px; "><h5 style="width: 140px; color: gray;margin: auto;" >Click to open</h5></div>
    ...
    <div class="row row-card " style="display: none; "   id="row7" >
      <div style="margin:auto;width: 90%;height: 80%">
        <div class="img3d"  style="margin-top: 100px;width: 50%; float: left;" >
          <div  class="front" style="float: left" id="img3d-7"><img src="chord library/E major.jpg" class="imgflip"></div>
        </div> 
        <div  style="width: 50% ;float: right;margin-top: 120px" class="answer-card-total"  >
          ...
          <div class="answer-card" id="wrong7-2" onclick="wrong('wrong7-2')"><h3 style="width: 140px; margin: auto;" >Am chord</h3></div>
        </div>
      </div>
    ...
    <div class="row row-card " style="display: none;"   id="row9">
      <div class="flip3d" style="margin-top: 100px;" >
        <div id="front9"  class="front"  onclick="fronttoback('front9','back9','continuous9')" ><img src="chord library/c major chord.jpg" class="imgflip"></div>
        <div id="back9" class="back"  onclick="backtofront('front9','back9')"><h1 class="fliptext">C chord</h1></div>
      </div> 
      <div style=" width: 100%;  height: 40px;margin-top: 0px; "><h5 style="width: 140px; color: gray;margin: auto;" >Click to open</h5></div>

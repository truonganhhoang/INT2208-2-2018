  ...
  <div class="row">
    ...
    <div class="col-lg-9">
      ...
      <div id="major" class="tabcontent">
        <img src="chord library/F major.jpg" class="chord-picture1">
        <img src="chord library/F major 2.jpg" class="chord-picture1">
        <img src="chord library/F major 3.jpg" class="chord-picture1">
        <img src="chord library/F major 4.jpg" class="chord-picture1">
        <img src="chord library/F major 5.jpg" class="chord-picture1">
      </div>
      <div id="minor" class="tabcontent chord-picture">
        <img src="chord library/F minor.jpg" class="chord-picture1">
        <img src="chord library/F minor 2.jpg"  class="chord-picture1">
        <img src="chord library/F minor 3.jpg"  class="chord-picture1">
      </div>
      <div id="5" class="tabcontent chord-picture">
        <img src="chord library/F5.jpg" class="chord-picture1">
        <img src="chord library/F5 1.jpg"  class="chord-picture1">
        <img src="chord library/F5 2.jpg"  class="chord-picture1">
      </div>
      <div id="7" class="tabcontent chord-picture">
        <img src="chord library/F7.jpg" class="chord-picture1">
        <img src="chord library/F7 1.jpg"  class="chord-picture1">
        <img src="chord library/F7 2.jpg"  class="chord-picture1">
        <img src="chord library/F7 3.jpg"  class="chord-picture1"> 
      </div>
      <div id="maj7" class="tabcontent chord-picture">
        <img src="chord library/Fmaj7.jpg" class="chord-picture1">
        <img src="chord library/Fmaj7 1.jpg"  class="chord-picture1">
        <img src="chord library/Fmaj7 2.jpg"  class="chord-picture1">
        <img src="chord library/Fmaj7 3.jpg"  class="chord-picture1"> 
        <img src="chord library/Fmaj7 4.jpg"  class="chord-picture1"> 
      </div>
      <div id="m7" class="tabcontent chord-picture">
        <img src="chord library/Fm7.jpg"  class="chord-picture1">
        <img src="chord library/Fm7 1.jpg"  class="chord-picture1">
        <img src="chord library/Fm7 2.jpg"  class="chord-picture1">
      </div>
      <div id="sus4" class="tabcontent chord-picture">
        <img src="chord library/Fsus4.jpg" class="chord-picture1">
        <img src="chord library/Fsus4 1.jpg"  class="chord-picture1">
        <img src="chord library/Fsus4 2.jpg"  class="chord-picture1">
      </div>
      <div id="add9" class="tabcontent chord-picture">
        <img src="chord library/Fadd9.jpg" class="chord-picture1">
      </div>
      <div id="sus2" class="tabcontent chord-picture">
        <img src="chord library/Fsus2.jpg" class="chord-picture1">
        <img src="chord library/Fsus2 1.jpg"  class="chord-picture1">
      </div>
      <div id="7sus4" class="tabcontent chord-picture">
        <img src="chord library/F7sus4.jpg" class="chord-picture1">
        <img src="chord library/F7sus4 1.jpg"  class="chord-picture1">
        <img src="chord library/F7sus4 2.jpg"  class="chord-picture1">
      </div>
      <div id="7#9" class="tabcontent chord-picture">
        <img src="chord library/F7thang9.jpg" class="chord-picture1">
        <img src="chord library/F7thang9 1.jpg"  class="chord-picture1">
      </div>
      <div id="9" class="tabcontent chord-picture">
        <img src="chord library/F9.jpg" class="chord-picture1">
        <img src="chord library/F9 1.jpg"  class="chord-picture1">
      </div>
      <!-- /.row -->

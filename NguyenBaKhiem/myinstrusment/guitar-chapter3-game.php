  ...
  <div class="col-lg-9">
    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-md-6 mb-4">
        <div class="card h-100 guitar-chapter3-game1" style="border-color: blue">
          <a href="#"><img class="card-img-top" src="img/guitar.jpg"></a>
          <div class="card-body">
            <h4 class="card-title">
              <a href="guitar-chapter3-game-G,D,Em,C.php" class="guitar-chapter3-game1" style="color: blue;">G,D,Em,C</a>
            </h4>
            <h5 class="card-text">learn C,D,Em,C</h5>
          </div>
          <div class="card-footer">
            <a href ="guitar-chapter3-game-G,D,Em,C.php" class="btn btn-primary">play</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-4 col-md-6 mb-4">
        <div class="card h-100 guitar-chapter3-game1" style="border-color: blue">
          <a href="#"><img class="card-img-top" src="img/acoustic-guitar-336479_960_720.jpg"></a>
          <div class="card-body">
            <h4 class="card-title">
              <a href="guitar-chapter3-game-F,Am,E,D7.php" class="guitar-chapter3-game1" style="color: blue;">F,Am,E,D7</a>
            </h4>
            <h5 class="card-text">learn F,Am,E,D7</h5>
          </div>
          <div class="card-footer">
            <a href ="guitar-chapter3-game-G,D,Em,C.php" class="btn btn-primary">play</a>
          </div>

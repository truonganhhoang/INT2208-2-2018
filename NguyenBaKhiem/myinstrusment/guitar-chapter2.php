    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-md-6 mb-4">
        <div class="card h-100 guitar-chapter2-lesson1">
          ...
          <div class="card-body">
            <h4 class="card-title">
              <a href="guitar-chapter2-lesson1.php" class="guitar-chapter2-lesson1-title">Lesson 1: Guitar shape</a>
            </h4>
            <h5 class="card-text">Learn about traditional guitar</h5>
          </div>
          <div class="card-footer">
            <a href ="guitar-chapter2-lesson1.php" class="btn btn-primary">Learn</a>
          </div>
        </div>
      </div>

      <div class="col-lg-4 col-md-6 mb-4">
        <div class="card h-100 guitar-chapter2-lesson2">
          <a href="#"><img class="card-img-top" src="img/khoa-hoc-dan-guitar-dem-hat-cap-toc-1.jpg" alt=""></a>
          <div class="card-body">
            <h4 class="card-title">
              <a href="guitar-chapter2-lesson2.php" class="guitar-chapter2-lesson2-title">Lesson 2: Guitar playing posture</a>
            </h4>
            <h5 class="card-text">Learn about guitr playing posture</h5>
          </div>
          <div class="card-footer">
            <a href ="guitar-chapter2-lesson2.php" class="btn btn-primary">Learn</a>
          </div>
        </div>
      </div>

      <div class="col-lg-4 col-md-6 mb-4">
        <div class="card h-100 guitar-chapter2-lesson3">
          <a href="#"><img class="card-img-top" src="img/tu the choi dan guitar bass(2).jpg" alt=""></a>
          <div class="card-body">
            <h4 class="card-title">
              <a href="guitar-chapter2-lesson3.php" class="guitar-chapter2-lesson3-title">Lesson 3: Finger's placement</a>
            </h4>
            <h5 class="card-text">Learn how to place hands on the guitar</h5>
          </div>
          <div class="card-footer">
            <a href ="/guitar-chapter2-lesson3.php" class="btn btn-primary">Learn</a>
          </div>
        </div>
      </div>

      <div class="col-lg-4 col-md-6 mb-4">
        <div class="card h-100 guitar-chapter2-lesson4">
          <a href="#"><img class="card-img-top" src="img/guitar-chord-640-804.jpg" alt=""></a>
          <div class="card-body">
            <h4 class="card-title">
              <a href="guitar-chapter2-lesson4.php" class="guitar-chapter2-lesson4-title">Lesson 4: Notes on guitar</a>
            </h4>
            <h5 class="card-text">Learn about notes on guitar</h5>
          </div>
          <div class="card-footer">
            <a href ="guitar-chapter2-lesson4.php" class="btn btn-primary">Learn</a>
          </div>
        </div>
      </div>

      <div class="col-lg-4 col-md-6 mb-4">
        <div class="card h-100 guitar-chapter2-lesson5">
          <a href="#"><img class="card-img-top" src="img/Desktop-Guitar-Wallpapers-High-Resolution-Photo.jpg" alt=""></a>
          <div class="card-body">
            <h4 class="card-title">
              <a href="guitar-chapter2-lesson5.php" class="guitar-chapter2-lesson5-title">Lesson 5: How to tune the guitar</a>
            </h4>
            <h5 class="card-text">Learn how to tune the guitar</h5>
          </div>
          <div class="card-footer">
            <a href ="guitar-chapter2-lesson5.php" class="btn btn-primary">Learn</a>
          </div>
        </div>
      </div>

      <div class="col-lg-4 col-md-6 mb-4">
        <div class="card h-100 guitar-chapter2-game">
          <a href="#"><img class="card-img-top" src="img/Les Paul Studio Black.jpg" alt=""></a>
          <div class="card-body">
            <h4 class="card-title">
              <a href="#" class="guitar-chapter2-game-title">Game</a>
            </h4>

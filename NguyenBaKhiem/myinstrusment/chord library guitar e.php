  ...
  <div class="row">
    ...
    <div class="col-lg-9">
      ...
      <div id="major" class="tabcontent">
        <img src="chord library/E major.jpg" class="chord-picture1">
        <img src="chord library/E major 2.jpg" class="chord-picture1">
        <img src="chord library/E major 3.jpg" class="chord-picture1">
        <img src="chord library/E major 4.jpg" class="chord-picture1">
      </div>
      <div id="minor" class="tabcontent chord-picture">
        <img src="chord library/Eminor.jpg" class="chord-picture1">
        <img src="chord library/Eminor 1.jpg"  class="chord-picture1">
        <img src="chord library/Eminor 2.jpg"  class="chord-picture1">
      </div>
      <div id="5" class="tabcontent chord-picture">
        <img src="chord library/E5.jpg" class="chord-picture1">
        <img src="chord library/E5 1.jpg"  class="chord-picture1">
        <img src="chord library/E5 2.jpg"  class="chord-picture1">
        <img src="chord library/E5 3.jpg"  class="chord-picture1"> 
      </div>
      <div id="7" class="tabcontent chord-picture">
        <img src="chord library/E7.jpg" class="chord-picture1">
        <img src="chord library/E7 1.jpg"  class="chord-picture1">
        <img src="chord library/E7 2.jpg"  class="chord-picture1">
        <img src="chord library/E7 3.jpg"  class="chord-picture1"> 
      </div>
      <div id="maj7" class="tabcontent chord-picture">
        <img src="chord library/Emaj7.jpg" class="chord-picture1">
        <img src="chord library/Emaj7 1.jpg"  class="chord-picture1">
        <img src="chord library/Emaj7 2.jpg"  class="chord-picture1">
        <img src="chord library/Emaj7 3.jpg"  class="chord-picture1"> 
        <img src="chord library/Emaj7 4.jpg"  class="chord-picture1"> 
      </div>
      <div id="m7" class="tabcontent chord-picture">
        <img src="chord library/Em7.jpg"  class="chord-picture1">
        <img src="chord library/Em7 1.jpg"  class="chord-picture1">
      </div>
      <div id="sus4" class="tabcontent chord-picture">
        <img src="chord library/Esus4.jpg" class="chord-picture1">
        <img src="chord library/Esus4 1.jpg"  class="chord-picture1">
        <img src="chord library/Esus4 2.jpg"  class="chord-picture1">
      </div>
      <div id="add9" class="tabcontent chord-picture">
        <img src="chord library/Eadd9.jpg" class="chord-picture1">
      </div>
      <div id="sus2" class="tabcontent chord-picture">
        <img src="chord library/Esus2.jpg" class="chord-picture1">
        <img src="chord library/Esus2 1.jpg"  class="chord-picture1">
      </div>
      ...
      <div id="7#9" class="tabcontent chord-picture">
        <img src="chord library/E7thang9.jpg" class="chord-picture1">
        <img src="chord library/E7thang9 1.jpg"  class="chord-picture1">
      </div>
      <div id="9" class="tabcontent chord-picture">
        <img src="chord library/E9.jpg" class="chord-picture1">
        <img src="chord library/E9 1.jpg"  class="chord-picture1">
      </div>
      <!-- /.row -->

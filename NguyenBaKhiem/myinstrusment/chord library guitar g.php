  ...
  <div class="row">
    ...
    <div class="col-lg-3">
      ...
      <div class="list-group menu1">
        ...
        <a href="chord library guitar c thang.php" class="list-group-item musictheory-lesson2-title">C#  chord</a>
        ...
        <a href="#" class="list-group-item musictheory-lesson8-title"><u>G chord</u></a>
    ...
    <div class="col-lg-9">
      ...
      <div id="major" class="tabcontent">
        <img src="chord library/G major.jpg" class="chord-picture1">
        <img src="chord library/G major 2.jpg" class="chord-picture1">
        <img src="chord library/G major 3.jpg" class="chord-picture1">
        <img src="chord library/G major 4.jpg" class="chord-picture1">
        <img src="chord library/G major 5.jpg" class="chord-picture1">
      </div>
      <div id="minor" class="tabcontent chord-picture">
        <img src="chord library/G minor.jpg" class="chord-picture1">
        <img src="chord library/G minor 1.jpg"  class="chord-picture1">
        <img src="chord library/G minor 2.jpg"  class="chord-picture1">
      </div>
      <div id="5" class="tabcontent chord-picture">
        <img src="chord library/G5.jpg" class="chord-picture1">
        <img src="chord library/G5 1.jpg"  class="chord-picture1">
        <img src="chord library/G5 2.jpg"  class="chord-picture1">
      </div>
      <div id="7" class="tabcontent chord-picture">
        <img src="chord library/G7.jpg" class="chord-picture1">
        <img src="chord library/G7 1.jpg"  class="chord-picture1">
        <img src="chord library/G7 2.jpg"  class="chord-picture1">
        <img src="chord library/G7 3.jpg"  class="chord-picture1"> 
      </div>
      <div id="maj7" class="tabcontent chord-picture">
        <img src="chord library/Gmaj7.jpg" class="chord-picture1">
        <img src="chord library/Gmaj7 1.jpg"  class="chord-picture1">
        <img src="chord library/Gmaj7 2.jpg"  class="chord-picture1">
        <img src="chord library/Gmaj7 3.jpg"  class="chord-picture1"> 
        <img src="chord library/Gmaj7 4.jpg"  class="chord-picture1"> 
      </div>
      <div id="m7" class="tabcontent chord-picture">
        <img src="chord library/Gm7.jpg"  class="chord-picture1">
        <img src="chord library/Gm7 1.jpg"  class="chord-picture1">
        <img src="chord library/Gm7 2.jpg"  class="chord-picture1">
      </div>
      <div id="sus4" class="tabcontent chord-picture">
        <img src="chord library/Gsus4.jpg" class="chord-picture1">
        <img src="chord library/Gsus4 1.jpg"  class="chord-picture1">
        <img src="chord library/Gsus4 2.jpg"  class="chord-picture1">
      </div>
      <div id="add9" class="tabcontent chord-picture">
        <img src="chord library/Gadd9.jpg" class="chord-picture1">
      </div>
      <div id="sus2" class="tabcontent chord-picture">
        <img src="chord library/Gsus2.jpg" class="chord-picture1">
        <img src="chord library/Gsus2 1.jpg"  class="chord-picture1">
      </div>
      <div id="7sus4" class="tabcontent chord-picture">
        <img src="chord library/G7sus4.jpg" class="chord-picture1">
        <img src="chord library/G7sus4 1.jpg"  class="chord-picture1">
        <img src="chord library/G7sus4 2.jpg"  class="chord-picture1">
      </div>
      <div id="7#9" class="tabcontent chord-picture">
        <img src="chord library/G7thang9.jpg" class="chord-picture1">
        <img src="chord library/G7thang9 1.jpg"  class="chord-picture1">
      </div>
      <div id="9" class="tabcontent chord-picture">
        <img src="chord library/G9.jpg" class="chord-picture1">
        <img src="chord library/G9 1.jpg"  class="chord-picture1">
      </div>
      <!-- /.row -->
